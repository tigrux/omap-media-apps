/* iconlist-control.c generated by valac 0.10.0, the Vala compiler
...
OmapIconListControl* omap_icon_list_control_construct (GType object_type, GtkListStore* model, GError** error) {
	...
	self = (OmapIconListControl*) omap_media_control_construct (object_type);
...
GtkListStore* omap_icon_list_control_model_new (void) {
	...
	b = G_TYPE_BOOLEAN;
	i = G_TYPE_INT;
	result = gtk_list_store_new (7, s, s, p, b, b, i, i);
	return result;
}
