/* playlist-control.c generated by valac 0.10.0, the Vala compiler
...
OmapPlayListControl* omap_play_list_control_construct (GType object_type, GtkListStore* store) {
	...
	self = (OmapPlayListControl*) omap_media_control_construct (object_type);
...
GtkListStore* omap_play_list_control_model_new (void) {
	...
	GType s;
	s = G_TYPE_STRING;
	result = gtk_list_store_new (5, s, s, s, s, s);
	return result;
}
